...
// this defines the events sent from the pages of softkeys. The whole P1-M requires 
#define P1M_KEYDEF_START "F0 1D 03 10 07 25 01 09 1C"
...
#define P1M_NAME_START "F0 1D 03 10 07 26 01 01 0a"
